...
Allow `card` components in the JSON-to-UI schema to define optional actions so an entire card can behave as a clickable surface with appropriate visual feedback.
