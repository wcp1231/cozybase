...
Manage the workspace lifecycle including directory structure, configuration, initialization, app discovery, platform database, git integration, and graceful resource cleanup. The Workspace is the top-level container that owns all apps and platform-level resources.
