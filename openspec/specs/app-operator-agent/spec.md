...
Define the Operator Agent usage layer for Stable APP interaction, including provider-neutral actions, runtime-backed session lifecycle, WebSocket access, and shared Builder/Operator session behavior.
